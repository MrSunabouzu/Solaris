...
#define TRAIT_CREEPY_AMBIENCE "Creepy Ambience" //replaces all ambience with creepy shit
...
#define TRAIT_SUNMARCHNATIVE "Sunmarch Native"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_GUARDSMAN = span_info("I am vigilant in my duties. In the town of Solaris Ridge, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_ZIRASIGHT = span_info("Zira blesses my eyes to be unburdened by the night."),
	...
	TRAIT_GUIDANCE = span_info("The arcane aides me in battle."),
	...
	TRAIT_GRAVEROBBER = span_info("My experience with 'post-mortem artifact recovery' has allowed me to resist Tsoridys' curse placed upon those who disturb resting places."),
